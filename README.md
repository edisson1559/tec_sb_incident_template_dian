# Proyecto integrador Curso DevOps Básico DIAN
...
- Branch protections en `main` y `develop`
- Pull requests con al menos 1 revisor y CI passing
 
## Contacto
- Equipo: edisson.caicedo1@gmail.com